...
namespace BaiTapNhom
{
    public partial class FormTKNVien : Form
    {
        ...
        private void btnTimKiem_Click(object sender, EventArgs e)
        {
            ...
            DataGrid_TimKiemNV.Columns[0].Width = 80;
            DataGrid_TimKiemNV.Columns[1].Width = 150;
            DataGrid_TimKiemNV.Columns[2].Width = 80;
            DataGrid_TimKiemNV.Columns[3].Width = 80;
            DataGrid_TimKiemNV.Columns[4].Width = 150;
